<h1 align="center"> 🚀 Alarm | Vanilla </h1>

## ✍️ Descrição
Exemplificação de aplicação de alarme usando vanilla ou Javascript puro
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/alarm-vanilla.git
    ```
1. Download:
    ### Download Manual
